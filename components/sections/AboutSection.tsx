    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <div className="grid items-start gap-8 md:grid-cols-[minmax(0,280px)_minmax(0,1fr)] md:gap-x-10 lg:grid-cols-[minmax(0,300px)_minmax(0,1fr)] lg:gap-x-12">
          {mainPhoto && (
            <div className="mx-auto w-full max-w-xs md:sticky md:top-28 md:mx-0 md:max-w-none md:self-start">
          ...
          <StaggerChildren className="min-w-0 space-y-4">
            {leadParagraphs.map((paragraph, index) => (
              <StaggerItem key={`about-lead-${index}`} variant="fadeUp">
            ...
            {(closingParagraph || accentPhoto) && (
              <div className="flex flex-col gap-5 pt-1 md:flex-row md:items-start md:justify-between md:gap-6 lg:gap-8">
                {closingParagraph && (
                  <SectionReveal variant="fadeUp" className="min-w-0 flex-1 md:max-w-[72%] lg:max-w-[68%]">
